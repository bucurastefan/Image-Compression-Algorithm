 ...
 */
@Getter
public abstract class LibraryEntry implements Searchable {
    ...
    public boolean matchesName(final String nameFilter) {
        return nameFilter == null || getName().toLowerCase().startsWith(nameFilter.toLowerCase());
    }
    ...
    /**
     * The LibraryEntry implementation of the getItem method
     * from the Searchable interface.
     * @return name of library entry
     */
    @Override
